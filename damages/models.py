...
class Damage(models.Model):
    roll = models.ForeignKey(Rolls, related_name='damages', on_delete=models.CASCADE,
                             null=True)  # maybe make this null since some damage is not associated with roll
