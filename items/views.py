...
from .serializers import PotionSerializer, PotionDetailSerializer, PotionUsageSerializer, WeaponSerializer, \
    WeaponDetailSerializer, WeaponDamageSerializer, WeaponOwnedSerializer, WeaponUsageSerializer
