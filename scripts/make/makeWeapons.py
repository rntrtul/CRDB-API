...
def getDamageType(str):
    ...
    damage_str = ['ltng', 'pierce', 'Fire', 'Piercing', 'Cold', 'Lightning', 'slash', 'fire', 'bludge', 'necro',
                  'slashing', 'bludgeoning', 'bludgeon',
    ...
    for weapon in weaps:
        ...
        if cleanedWpn != "0 0 0":
            ...
            if die1 != "False" and die1Mod != "False" and type1 != "False":
                wpnDmg1, created = WeaponDamage.objects.get_or_create(weapon=wpn, die=die, modifier=die1Mod,
                                                                      damage_type=dt1, die_num=num)
                if created:
                ...
                wpnDmg1, created = WeaponDamage.objects.get_or_create(weapon=wpn, die=die, modifier=0, damage_type=dt1,
                                                                      die_num=num)
                if created:
            ...
            if die2 != "False" and die2Mod != "False" and type2 != "False":
                wpnDmg2, created = WeaponDamage.objects.get_or_create(weapon=wpn, die=die, modifier=die2Mod,
                                                                      damage_type=dt2, die_num=num)
                if created:
                ...
                wpnDmg2, created = WeaponDamage.objects.get_or_create(weapon=wpn, die=die, modifier=0, damage_type=dt2,
                                                                      die_num=num)
                if created:
